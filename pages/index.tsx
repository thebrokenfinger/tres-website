        ...
        <Container size="3">
          ...
          >
            <Box css={{ width: "100%", textAlign: "right", my: "$2" }}>
              <Text size="2">
                Built with{" "}
                <Anchor href="https://www.radix-ui.com/">
                  Radix Primitives
                </Anchor>{" "}
                and <Anchor href="https://stitches.dev/">Stitches</Anchor>
              </Text>
            </Box>
            <Flex
              direction="column"
            ...
            >
              ...
              <Text colorScheme="gray" size="5" css={{ my: "$2" }}>
                ...
                <Anchor href="https://workos.com">WorkOS</Anchor> design system
              </Text>
              <Flex gap="3">
          ...
          <Flex gap="6" css={{ my: "$9" }} direction="column">
            <Flex gap="2" direction="column">
              ...
              <Paragraph>
                ...
                your app is gonna look really eats up important time. Moreover,
                I don&apos;t like the look and feel of components that ship with
                UI libraries like Chakra, Antd, Material UI, and others.
              </Paragraph>
              <Paragraph>
                ...
                &ldquo;branding&rdquo;. And of course, it isn&apos;t very
                configurable. I don&apos;t like that. I wanted a UI library that
                has no branding, no colors (grayscale), and is configurable. So
                I forked the WorkOS design system and started creating my own
                React UI library with a slightly different API than that of
                WorkOS&apos;s.
              </Paragraph>
            ...
            <Flex gap="2" direction="column">
              ...
              <Paragraph>
                ...
                <strong>TrES-2b</strong>. It&apos;s a fascinating planet because
                it reflects no more than 1% of light. And for that reason, looks
                all black most of the time.
              </Paragraph>
            </Flex>
            <Flex gap="2" direction="column">
              ...
              <Paragraph>
                ...
                components{" "}
                <Anchor href="https://github.com/radix-ui/design-system/blob/master/pages/index.tsx">
                  here
                </Anchor>
                .
              </Paragraph>
